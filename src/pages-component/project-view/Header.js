...
import { ChevronDown, Filter, LayoutGrid, MoreHorizontal, Share2, Star, Zap } from "lucide-react"
...
export default function WorkSpaceHeader() {
  return (
    <header className="flex h-12 items-center justify-between border-b bg-[#1D2125] px-4">
      ...
      <div className="flex items-center gap-2">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" size="sm" className="h-8 gap-2 bg-white/10 px-3 text-white hover:bg-white/20">
      ...
      <div className="flex items-center gap-2">
        <Button variant="ghost" size="sm" className="h-8 gap-2 text-white hover:bg-white/10">
        ...
        <div className="flex h-8 items-center rounded bg-white/10 px-3 text-sm text-white">W3</div>
        <Button variant="ghost" size="sm" className="h-8 gap-2 text-white hover:bg-white/10">
