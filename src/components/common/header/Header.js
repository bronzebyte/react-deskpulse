...
export default function Header() {
  ...
  return (
    <nav className="flex items-center px-4 h-12 bg-white border-b sticky top-0 z-10 dark:bg-gray-900">
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        >
          <div className="flex flex-col justify-center items-center w-full">
            ...
            <p className="text-center mt-5  hover:text-white">
        ...
        <div className="dark:text-white">
          ...
          <CommonDrawer
            ...
            title="Settings"
          >
            <div className="flex items-center space-x-2 bg-[#F8F8F8] py-6 px-2 rounded-sm">
              <div className="flex h-20 w-20  items-center text-3xl justify-center rounded-full bg-blue-900 text-white font-bold">
                BB
              </div>
              ...
              <div className="relative">
                <Popover placement="left">
                  <PopoverTrigger className="w-full">
                    <Button className="bg-unset shadow-none p-0 w-full" >
